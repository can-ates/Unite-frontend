...
const Header = props => {
    ...
    <React.Fragment>
      ...
      >
        ...
        {props.user.isAuth ? <Tab
            ...
            disableRipple
            label={
              <Typography style={{ fontSize: '0.770rem' }} variant='inherit'>
                <span style={{ color: 'white' }}> Hello,</span>
                <span style={{ display: 'block', fontSize: '0.79rem' }}>
                  {props.user.name}
                </span>
              </Typography>
            }
  ...
  return (
    <React.Fragment>
      <ElevationScroll>
        <AppBar
          position={toggleHeader ? 'fixed' : 'absolute'}
          className={classes.appbar}
          style={{
            backgroundColor: toggleHeader
              ? null
              : uri === 'community' ||
                uri === 'joinus' ||
...
export default connect()(Auth(Header, true));
